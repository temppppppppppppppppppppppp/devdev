...
- **Global scope**: `C:/Users/wjjo/Desktop/글도비/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/wjjo/Desktop/글도비/.claude/notes/`)
...
2. Glob `C:/Users/wjjo/Desktop/글도비/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/wjjo/Desktop/글도비/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/wjjo/Desktop/글도비/.claude/notes/` — works in any directory
