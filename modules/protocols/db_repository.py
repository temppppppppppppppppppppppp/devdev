...
class DBRepositoryProtocol(Protocol):
    ...
    def save_manuscript(self, ep_num: int, title: str, content: str) -> None: ...
    def get_manuscript(self, ep_num: int) -> Optional[dict]: ...
    ...
    def save_surgery_log(
        self, ep_num: int, category: str, failed_logic: str, result: str,
    ) -> None: ...
    ...
    def get_lore_item(self, item_name: str) -> Optional[dict]: ...
    ...
    def update_karma(
        self, npc_name: str, mis_val: float, obs_val: float, ep_num: int,
    ) -> None: ...
    ...
    def commit_episode_factory(
        ...
        karma_data: list,
        lore_data: list,
        recovered_seeds: Optional[list] = None,
    ) -> bool: ...
    ...
    def get_sync_status(self, ep_num: int) -> Optional[dict]: ...
    ...
    def get_recent_manuscript_excerpts(
        self, before_ep: int, limit: int = 10, max_chars: int = 200,
    ) -> list: ...
