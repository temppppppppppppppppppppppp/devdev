...
class ConsistencyValidator:
    ...
    def _check_relation_dynamics(self, manuscript: str, karma_matrix: dict, context: dict) -> dict:
        ...
        for npc_name, npc_data in karma_matrix.items():
            ...
            if events and len(events) > 0:
                ...
                contradiction_patterns = self._get_relation_contradiction_patterns(
                    npc_name, relation_type, event_type
                )
            ...
            for forbidden_use in cannot_be_used_for:
                ...
                if re.search(use_pattern, manuscript, re.IGNORECASE):
                    ...
                    has_transformation = any(
                        re.search(tp, manuscript) for tp in transformation_patterns
                    )
    ...
    def _check_attitude_transition(self, manuscript: str, npc_profiles: dict,
                                    karma_matrix: dict, prev_events: list) -> dict:
        """
        태도 전환 일관성 검증
    ...
    def _get_relation_contradiction_patterns(self, npc_name: str, relation_type: str,
    ...
    def _generate_feedback(self, violations: list, justifiable: list,
                           unjustifiable: list) -> str:
        """피드백 메시지 생성"""
        feedback_parts = []
