...
class WuxiaGuard(BaseGuard):
    ...
    def __init__(self) -> None:
        ...
        # 무협 금기어 목록
        # [V60.85] 체육관/헬스 용어, 현대 단위 추가
        # [V60.86] 원고 스캔 기반 추가 금지어 (소프트웨어, 아카데미, 메소드, 쇼크, 회전근개, 사브르 등)
        self.FORBIDDEN_TERMS = [
            ...
            # [V60.85] 체육관/헬스 용어 (현대인 빙의자 착각 방지)
            "펌핑", "펌핑감", "쇠질", "헬스", "헬스장", "운동기구", "덤벨", "바벨", "스쿼트", "데드리프트",
            "벤치프레스", "프로틴", "보충제", "유산소", "무산소", "근비대", "벌크업", "컷팅", "루틴",
            # [V60.85] 현대 단위 (괄호 없이 사용 시)
            "킬로그램", "킬로미터", "센티미터", "밀리미터",
            # [V60.86] 원고 스캔 기반 추가 금지어
            # IT/컴퓨터 용어
            "소프트웨어", "하드웨어", "프로그램", "코드", "알고리즘", "버그", "디버깅",
            # 영화/엔터테인먼트 용어
            "아카데미", "메소드", "연기", "오스카", "에미상", "감독상", "주연상",
            # 의학/해부학 현대 용어
            "쇼크", "쇼크사", "회전근개", "인대", "연골", "디스크", "근섬유", "관절염",
            "아드레날린", "도파민", "세로토닌", "호르몬", "항체", "면역",
            # 외래어 무기/도구
            "사브르", "레이피어", "에페", "플뢰레", "머스킷", "라이플",
            # 현대 생활/개념
            "현대의 기억", "전생의 현대", "지구의", "21세기", "20세기",
            # 현대 감각 표현 (회귀자라도 금지)
            "화학 반응", "근육세포", "근섬유"
        ]
        ...
        # [V60.85] 괄호 없는 현대 단위도 추가
        # [V60.86] 한글 현대 단위, 대용량 숫자kg 패턴 추가
