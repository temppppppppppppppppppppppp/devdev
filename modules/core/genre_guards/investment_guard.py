...
10. **전문가 반응 캘리브레이션**: 금융 전문가(PB, 펀드매니저 등)의 반응은 직급·경험에 비례해야 한다. VIP PB가 수십억 자산에 놀라면 안 된다(일상). 3배 레버리지 원유선물 올인이나 마진콜 직전 상황에는 놀라야 한다(실제 위험). 전문가는 자기 영역의 일상적 수치에 둔감하고, 리스크 프로파일의 이상 신호에만 반응한다.
