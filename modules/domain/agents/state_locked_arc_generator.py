...
class StateLockedArcGenerator(BaseAgent):
    ...
    def __init__(self, context, client, model_tier: str = None):
        ...
        self.extraction_model = "gemini-3.1-pro-preview"  # 추출도 Gemini 3
        self.draft_model = "gemini-3.1-pro-preview"  # [V60.17] Speculative: 초안용 모델
...
def create_state_locked_generator(context, client, model_tier: str = "gemini-3.1-pro-preview"):
