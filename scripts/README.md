...
| Preview or post the benchmark operator markdown snapshot directly to a GitHub issue comment | `python scripts/post_benchmark_operator_comment.py [--repo <owner/name> --issue-number <n> --post] [--pair <left> <right>]` |
