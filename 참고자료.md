...
Phase 2.5: DB 통합 (SSOT) ← 미착수                             ★★★★☆
  ...
  ↓
Phase 3:   검증 & 안정화 ← 미착수                               ★★★★☆
           ├─ 3-A: Pydantic ValidationError 추가 버그 수정      ★★☆☆☆
           ├─ 3-B: Silent pass 59건 정리                       ★★☆☆☆
           ├─ 3-C: NPC 연속성 시나리오 24개 대응                 ★★★★☆
  ...
  ↓
Phase 4:   구조 개선 ← 미착수                                   ★★★★★
           ├─ God Object 분해 (self.app → DI)                  ★★★★★
           ├─ 대형 파일 분할                                    ★★★★☆
           └─ async/sync 통일                                  ★★★☆☆
  ↓
Phase 5:   프롬프트 외부화 & 설정 관리                           ★★☆☆☆
           ├─ 5-A: 프롬프트 외부화 (43개 YAML) ✅              ★★☆☆☆
           ├─ 5-A': import 전환 (40+파일) ← 미착수             ★★☆☆☆
           ├─ 5-B: Settings YAML + 가드 외부화 ← 미착수        ★★★☆☆
           │       (댓글 반응, 시점, 대리만족 설정 통합)
           └─ 5-C: 의존성 정리 ✅                              ★☆☆☆☆
  ↓
Phase 6:   테스트 & CI                                         ★★☆☆☆
