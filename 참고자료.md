...
| 7 | **Phase 6-B (E2E 테스트)** | **⏳ 다음** | ★★★★☆ |
| 8 | Phase 4 잔여 (대형 함수 분할, async 통일 등) | ⏳ 후순위 | ★★★★★ |
...
- **현재 단계**: Phase 6-B 대기 (E2E 테스트)
- **주요 약점**: NPC 연속성 추적 개선됨 (이력 DB 도입), 플롯 중복 감지 불안정 (Chain 1)
...
| 6 | **6-B** | **E2E 테스트** | 5-B ✅ ← **다음** |
| 7 | 4(잔여) | God Object 분해 + 파일 분할 | 6-B 이후 |
