...
| 2 | 5-B | Settings YAML 통합 + 장르/작품 가드 외부화 | 중 |
| 3 | 6-A | pytest 테스트 도입 | 중 |
| 4 | 6-C | pre-commit + ruff 설정 | 소 |
...
```
주 1: [S] 5-A' import 전환 + 6-C pre-commit + 6-A pytest     ← Sonnet 청소
