...
산출물 경로는 아래처럼 고정한다.
- Phase 0: `treatments\us_ai_exile_monopoly_phase0_design.json`
- TR draft: `treatments\us_ai_exile_monopoly_tr_block_070_draft.json`
...
출력은 `treatments\us_ai_exile_monopoly_phase0_design.json`에 UTF-8로 저장하라.
...
아래 문서를 UTF-8 기준으로 읽어라.
- `docs\blockguide\treatment-production-harness-v2.md`
- `treatments\us_ai_exile_monopoly_phase0_design.json`

위 문서를 SSOT로 삼아 TR 70블록을 자동 진행으로 끝까지 생산하라.
출력은 `treatments\us_ai_exile_monopoly_tr_block_070_draft.json`에 UTF-8로 저장하라.
...
- `docs\blockguide\bi-production-harness-v1.md`
- `treatments\us_ai_exile_monopoly_phase0_design.json`
- `treatments\us_ai_exile_monopoly_tr_block_070_draft.json`

위 문서를 SSOT로 삼아 BI를 생성하라.
출력은 `bible\0_bi_us_ai_exile_monopoly.json`에 UTF-8로 저장하라.
...
- `treatments\us_ai_exile_monopoly_phase0_design.json`
- `treatments\us_ai_exile_monopoly_tr_block_070_draft.json`
- `bible\0_bi_us_ai_exile_monopoly.json`
