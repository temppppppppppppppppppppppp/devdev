...
```text
작품명은 `미국이 버린 AI 천재는 한국에서 독점한다`.
work_id는 `us_ai_exile_monopoly`로 고정한다.
...
위 문서 기준으로 `미국이 버린 AI 천재는 한국에서 독점한다`의 해당 섹션을 찾아, 그 기획을 기반으로 자동 진행하라.
...
- 대리만족이 최우선이다.
- 기술 설명보다 병목 독점, 통제권, 사용료, 협상력, 시장 지배를 우선한다.
...
산출물 경로는 아래처럼 고정한다.
- Phase 0: `C:\Users\wjjo\Desktop\글도비\treatments\us_ai_exile_monopoly_phase0_design.json`
- TR draft: `C:\Users\wjjo\Desktop\글도비\treatments\us_ai_exile_monopoly_tr_block_070_draft.json`
- BI: `C:\Users\wjjo\Desktop\글도비\bible\0_bi_us_ai_exile_monopoly.json`
...
```text
작품명은 `미국이 버린 AI 천재는 한국에서 독점한다`, work_id는 `us_ai_exile_monopoly`이다.
...
출력은 `C:\Users\wjjo\Desktop\글도비\treatments\us_ai_exile_monopoly_phase0_design.json`에 UTF-8로 저장하라.
...
아래 문서를 UTF-8 기준으로 읽어라.
- `C:\Users\wjjo\Desktop\글도비\docs\blockguide\treatment-production-harness-v2.md`
- `C:\Users\wjjo\Desktop\글도비\treatments\us_ai_exile_monopoly_phase0_design.json`

위 문서를 SSOT로 삼아 TR 70블록을 자동 진행으로 끝까지 생산하라.
출력은 `C:\Users\wjjo\Desktop\글도비\treatments\us_ai_exile_monopoly_tr_block_070_draft.json`에 UTF-8로 저장하라.
...
- `C:\Users\wjjo\Desktop\글도비\docs\blockguide\bi-production-harness-v1.md`
- `C:\Users\wjjo\Desktop\글도비\treatments\us_ai_exile_monopoly_phase0_design.json`
- `C:\Users\wjjo\Desktop\글도비\treatments\us_ai_exile_monopoly_tr_block_070_draft.json`

위 문서를 SSOT로 삼아 BI를 생성하라.
출력은 `C:\Users\wjjo\Desktop\글도비\bible\0_bi_us_ai_exile_monopoly.json`에 UTF-8로 저장하라.
...
- `C:\Users\wjjo\Desktop\글도비\treatments\us_ai_exile_monopoly_phase0_design.json`
- `C:\Users\wjjo\Desktop\글도비\treatments\us_ai_exile_monopoly_tr_block_070_draft.json`
- `C:\Users\wjjo\Desktop\글도비\bible\0_bi_us_ai_exile_monopoly.json`
...
- 이 작품은 기술 설명보다 `독점`, `병목`, `사용료`, `규격 장악`, `미국과 한국 재벌을 동시에 협상 상대로 만드는 구조`를 계속 강조해야 한다.
