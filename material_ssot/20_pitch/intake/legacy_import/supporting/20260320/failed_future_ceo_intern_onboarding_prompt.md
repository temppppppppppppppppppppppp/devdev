...
> 사용 대상 작품: `망한 미래의 CEO가 인턴으로 빙의했다`
> work_id 권장값: `failed_future_ceo_intern`
...
```text
작품명은 `망한 미래의 CEO가 인턴으로 빙의했다`.
work_id는 `failed_future_ceo_intern`으로 고정한다.
...
위 문서 기준으로 `망한 미래의 CEO가 인턴으로 빙의했다`의 해당 섹션을 찾아, 그 기획을 기반으로 자동 진행하라.
...
- 대리만족이 최우선이다.
- 회개보다 선점, 충성보다 지배, 성과보다 통제권과 지분을 우선한다.
- 권한 없는 인턴 출발점에서 임원, 오너가, 사내 정치, 외부 자본을 역이용하는 구조를 우선한다.
...
산출물 경로는 아래처럼 고정한다.
- Phase 0: `C:\Users\wjjo\Desktop\글도비\treatments\failed_future_ceo_intern_phase0_design.json`
- TR draft: `C:\Users\wjjo\Desktop\글도비\treatments\failed_future_ceo_intern_tr_block_070_draft.json`
- BI: `C:\Users\wjjo\Desktop\글도비\bible\0_bi_failed_future_ceo_intern.json`
...
```text
작품명은 `망한 미래의 CEO가 인턴으로 빙의했다`, work_id는 `failed_future_ceo_intern`이다.
...
출력은 `C:\Users\wjjo\Desktop\글도비\treatments\failed_future_ceo_intern_phase0_design.json`에 UTF-8로 저장하라.
...
아래 문서를 UTF-8 기준으로 읽어라.
- `C:\Users\wjjo\Desktop\글도비\docs\blockguide\treatment-production-harness-v2.md`
- `C:\Users\wjjo\Desktop\글도비\treatments\failed_future_ceo_intern_phase0_design.json`

위 문서를 SSOT로 삼아 TR 70블록을 자동 진행으로 끝까지 생산하라.
출력은 `C:\Users\wjjo\Desktop\글도비\treatments\failed_future_ceo_intern_tr_block_070_draft.json`에 UTF-8로 저장하라.
...
- `C:\Users\wjjo\Desktop\글도비\docs\blockguide\bi-production-harness-v1.md`
- `C:\Users\wjjo\Desktop\글도비\treatments\failed_future_ceo_intern_phase0_design.json`
- `C:\Users\wjjo\Desktop\글도비\treatments\failed_future_ceo_intern_tr_block_070_draft.json`

위 문서를 SSOT로 삼아 BI를 생성하라.
출력은 `C:\Users\wjjo\Desktop\글도비\bible\0_bi_failed_future_ceo_intern.json`에 UTF-8로 저장하라.
...
- `C:\Users\wjjo\Desktop\글도비\treatments\failed_future_ceo_intern_phase0_design.json`
- `C:\Users\wjjo\Desktop\글도비\treatments\failed_future_ceo_intern_tr_block_070_draft.json`
- `C:\Users\wjjo\Desktop\글도비\bible\0_bi_failed_future_ceo_intern.json`
...
- 이 작품은 반성보다 `선점`, `권한 없는 상태에서의 우회 장악`, `성과를 지분과 권력으로 전환`, `오너가와 임원진을 역이용하는 구조`를 계속 강조해야 한다.
