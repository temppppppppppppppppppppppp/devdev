...
- research material pack: `material_ssot/10_research/30_work_materials/wuxia_heavenly_physician/90_material_pack.json`
- preprocess dir: `treatments/preprocess/wuxia_heavenly_physician`
- preprocess manifest: `treatments/preprocess/wuxia_heavenly_physician/source_manifest.json`
...
- source manifest title: 천의무쌍(天醫武雙) <!-- utf8-hygiene: allow-line rationale: legitimate Sino-Korean title spelling in the canonical work title. -->
...
- research manifest: `material_ssot/10_research/manifests/wuxia_heavenly_physician.md`
- pitch anchor: `material_ssot/20_pitch/canon/wuxia_heavenly_physician.md`
- next stage manifest: `material_ssot/40_phase0_design/work-index/wuxia_heavenly_physician.md`
