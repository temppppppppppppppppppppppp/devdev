...
- 주요 장소마다 어떤 장면 기능을 담당하는지 구분돼 있다.
- 같은 장소를 연속 재사용하더라도 기능/주도권/평가자 구도를 바꿀 수 있을 만큼
  세부 구역, 시간대, 목격자 재료가 들어 있다.
...
| `medical_professional_profile` | 병원 위계, 진료과, 집도권, 레퍼럴, 프로토콜, 책임선, 기록 체계 | 전문성 단계, 집도권, 병원 정치, 책임 선점 근거 |
