# Pair Benchmark Terminal 07 Pair 07 Prompt

Date: 2026-04-07
Status: active
Document Type: external model prompt
Canonical Path: `docs/2026-04-07/09pair_benchmark_terminal07_pair07_prompt.md`
Parent Order: `docs/2026-04-07/09pair_production_pair_benchmark_9terminal_opus_order.md`
Intended Report Path: `docs/2026-04-07/09pair_benchmark_terminal07_pair07_report.md`

## Mission

Run a read-only benchmark audit for pair `07` only.
...
6. this prompt
7. `treatments/07_office_checkup_next_day_tr_block_070_draft.json`
8. `bible/07_bi_office_checkup_next_day.json`
...
- `docs/2026-04-07/09pair_benchmark_terminal07_pair07_report.md`
