# Pair Benchmark Terminal 02 Pair 02 Prompt

Date: 2026-04-07
Status: active
Document Type: external model prompt
Canonical Path: `docs/2026-04-07/09pair_benchmark_terminal02_pair02_prompt.md`
Parent Order: `docs/2026-04-07/09pair_production_pair_benchmark_9terminal_opus_order.md`
Intended Report Path: `docs/2026-04-07/09pair_benchmark_terminal02_pair02_report.md`

## Mission

Run a read-only benchmark audit for pair `02` only.
...
6. this prompt
7. `treatments/02_chaebol_allowance_zero_tr_block_070_draft.json`
8. `bible/02_bi_chaebol_allowance_zero.json`
...
- pay special attention to whether early gains are visible `cider` or only survival/probation relief
- verify that block-1 reward actually opens block 2 instead of just stopping immediate pain

## Required Output

Create the final markdown report directly at:

- `docs/2026-04-07/09pair_benchmark_terminal02_pair02_report.md`
