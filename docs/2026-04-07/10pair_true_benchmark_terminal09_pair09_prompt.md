# 10pair True Benchmark Terminal 09 Pair 09 Prompt

Date: 2026-04-07
Status: active
Document Type: external model prompt
Canonical Path: `docs/2026-04-07/10pair_true_benchmark_terminal09_pair09_prompt.md`
Parent Order: `docs/2026-04-07/10pair_true_benchmark_10terminal_opus_order.md`
Intended Report Path: `docs/2026-04-07/10pair_true_benchmark_terminal09_pair09_report.md`

## Mission

Run a read-only true benchmark audit for canonical pair `09` only.
...
- respect `wuxguide` family logic; do not import non-wuxia token assumptions blindly
...
6. `docs/wuxguide/SSOT_wuxguide-integrated-order.md`
7. `work_guards/09_wuxia_heavenly_physician.yaml`
8. `treatments/09_wuxia_heavenly_physician_tr_block_070_draft.json`
9. `bible/09_bi_wuxia_heavenly_physician.json`
...
- training, recovery, or pain-management alone is not cider
- painful wuxia blocks still need same-block receipt: reevaluation, protection, manual access, realm step, or next-gate ticket

## Required Output

Create the final markdown report directly at:

- `docs/2026-04-07/10pair_true_benchmark_terminal09_pair09_report.md`
