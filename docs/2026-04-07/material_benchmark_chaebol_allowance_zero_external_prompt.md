# 재벌 3세인데 용돈이 0원 Material Benchmark Prompt

Date: 2026-04-07
Status: active
Document Type: external model prompt
Benchmark Type: material
Intended Report Path: `docs/2026-04-07/material_benchmark_chaebol_allowance_zero_external_report.md`

## Mission

Run a read-only material benchmark for `chaebol_allowance_zero` only.
...
4. `material_ssot/20_pitch/canon/chaebol_allowance_zero.md`
5. this prompt

## Assigned Target

- target id: `chaebol_allowance_zero`
- benchmark type: `material`
- family: `blockguide`
- Pitch: `material_ssot/20_pitch/canon/chaebol_allowance_zero.md`
...
- `docs/2026-04-07/material_benchmark_chaebol_allowance_zero_external_report.md`
