# 10pair True Benchmark Terminal 06 Pair 06 Prompt

Date: 2026-04-07
Status: active
Document Type: external model prompt
Canonical Path: `docs/2026-04-07/10pair_true_benchmark_terminal06_pair06_prompt.md`
Parent Order: `docs/2026-04-07/10pair_true_benchmark_10terminal_opus_order.md`
Intended Report Path: `docs/2026-04-07/10pair_true_benchmark_terminal06_pair06_report.md`

## Mission

Run a read-only true benchmark audit for canonical pair `06` only.
...
7. `work_guards/06_gatekeeper_heir.yaml`
8. `treatments/06_gatekeeper_heir_tr_block_070_draft.json`
9. `bible/06_bi_gatekeeper_heir.json`
...
- hidden proof or delayed reveal cannot hide a missing same-block receipt; require the proof scene to convert into visible entry-ticket or reevaluation on time

## Required Output

Create the final markdown report directly at:

- `docs/2026-04-07/10pair_true_benchmark_terminal06_pair06_report.md`
