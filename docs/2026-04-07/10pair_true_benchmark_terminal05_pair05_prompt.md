# 10pair True Benchmark Terminal 05 Pair 05 Prompt

Date: 2026-04-07
Status: active
Document Type: external model prompt
Canonical Path: `docs/2026-04-07/10pair_true_benchmark_terminal05_pair05_prompt.md`
Parent Order: `docs/2026-04-07/10pair_true_benchmark_10terminal_opus_order.md`
Intended Report Path: `docs/2026-04-07/10pair_true_benchmark_terminal05_pair05_report.md`

## Mission

Run a read-only true benchmark audit for canonical pair `05` only.
...
7. `work_guards/05_failed_future_ceo_intern.yaml`
8. `treatments/05_failed_future_ceo_intern_tr_block_070_draft.json`
9. `bible/05_bi_failed_future_ceo_intern.json`
...
- intern survival, praise, or probation extension alone does not count; require visible authority, task ownership, or public reevaluation token

## Required Output

Create the final markdown report directly at:

- `docs/2026-04-07/10pair_true_benchmark_terminal05_pair05_report.md`
