# Pair Benchmark Terminal 09 Pair 09 Prompt

Date: 2026-04-07
Status: active
Document Type: external model prompt
Canonical Path: `docs/2026-04-07/09pair_benchmark_terminal09_pair09_prompt.md`
Parent Order: `docs/2026-04-07/09pair_production_pair_benchmark_9terminal_opus_order.md`
Intended Report Path: `docs/2026-04-07/09pair_benchmark_terminal09_pair09_report.md`

## Mission

Run a read-only benchmark audit for pair `09` only.
...
4. `docs/wuxguide/SSOT_wuxguide-integrated-order.md`
5. `docs/2026-04-07/09pair_production_pair_benchmark_9terminal_opus_order.md`
6. this prompt
7. `treatments/09_wuxia_heavenly_physician_tr_block_070_draft.json`
8. `bible/09_bi_wuxia_heavenly_physician.json`
...
- this is a high-pain lane, so pain is allowed only when reward cadence still survives
- check whether same-block or next-block payback is strong enough to prevent `고구마` accumulation

## Required Output

Create the final markdown report directly at:

- `docs/2026-04-07/09pair_benchmark_terminal09_pair09_report.md`
