# Pair Benchmark Terminal 05 Pair 05 Prompt

Date: 2026-04-07
Status: active
Document Type: external model prompt
Canonical Path: `docs/2026-04-07/09pair_benchmark_terminal05_pair05_prompt.md`
Parent Order: `docs/2026-04-07/09pair_production_pair_benchmark_9terminal_opus_order.md`
Intended Report Path: `docs/2026-04-07/09pair_benchmark_terminal05_pair05_report.md`

## Mission

Run a read-only benchmark audit for pair `05` only.
...
6. this prompt
7. `treatments/05_failed_future_ceo_intern_tr_block_070_draft.json`
8. `bible/05_bi_failed_future_ceo_intern.json`
...
- watch for punishment spiral, passive suffering, or delay-only reward disguised as drama
- if major defeats do not hand back a next card quickly, mark the cap rule directly

## Required Output

Create the final markdown report directly at:

- `docs/2026-04-07/09pair_benchmark_terminal05_pair05_report.md`
