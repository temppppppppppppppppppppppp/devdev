# 10pair True Benchmark Terminal 10 Pair 10 Prompt

Date: 2026-04-07
Status: active
Document Type: external model prompt
Canonical Path: `docs/2026-04-07/10pair_true_benchmark_terminal10_pair10_prompt.md`
Parent Order: `docs/2026-04-07/10pair_true_benchmark_10terminal_opus_order.md`
Intended Report Path: `docs/2026-04-07/10pair_true_benchmark_terminal10_pair10_report.md`

## Mission

Run a read-only true benchmark audit for canonical pair `10` only.
...
- `pair 10` means `jaebeol3se_loss_line`; do not substitute `permit_window_grade9`
...
7. `work_guards/10_jaebeol3se_loss_line.yaml`
8. `treatments/10_jaebeol3se_loss_line_tr_block_070_draft.json`
9. `bible/10_bi_jaebeol3se_loss_line.json`
...
- `loss line` framing does not excuse rewardless defeat, humiliation-only beats, or pain-only exits
- do not accidentally benchmark `permit_window_grade9`; that file is outside this canonical wave

## Required Output

Create the final markdown report directly at:

- `docs/2026-04-07/10pair_true_benchmark_terminal10_pair10_report.md`
