# Pair Benchmark Terminal 03 Pair 03 Prompt

Date: 2026-04-07
Status: active
Document Type: external model prompt
Canonical Path: `docs/2026-04-07/09pair_benchmark_terminal03_pair03_prompt.md`
Parent Order: `docs/2026-04-07/09pair_production_pair_benchmark_9terminal_opus_order.md`
Intended Report Path: `docs/2026-04-07/09pair_benchmark_terminal03_pair03_report.md`

## Mission

Run a read-only benchmark audit for pair `03` only.
...
6. this prompt
7. `treatments/03_chaebol_ent_empire_tr_block_070_draft.json`
8. `bible/03_bi_chaebol_ent_empire.json`
...
- check whether entertainment-business texture is concrete enough to count as domain truth density
- make sure repeatable loop clarity is real, not just one flashy opening win

## Required Output

Create the final markdown report directly at:

- `docs/2026-04-07/09pair_benchmark_terminal03_pair03_report.md`
