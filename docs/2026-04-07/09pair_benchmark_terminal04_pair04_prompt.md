# Pair Benchmark Terminal 04 Pair 04 Prompt

Date: 2026-04-07
Status: active
Document Type: external model prompt
Canonical Path: `docs/2026-04-07/09pair_benchmark_terminal04_pair04_prompt.md`
Parent Order: `docs/2026-04-07/09pair_production_pair_benchmark_9terminal_opus_order.md`
Intended Report Path: `docs/2026-04-07/09pair_benchmark_terminal04_pair04_report.md`

## Mission

Run a read-only benchmark audit for pair `04` only.
...
6. this prompt
7. `treatments/04_defense_defect_engineer_tr_block_070_draft.json`
8. `bible/04_bi_defense_defect_engineer.json`
...
- verify that the technical lane turns proof into public reevaluation and authority, not just technical correctness
- if domain truth is strong but reward token is weak, grade the weakness directly

## Required Output

Create the final markdown report directly at:

- `docs/2026-04-07/09pair_benchmark_terminal04_pair04_report.md`
