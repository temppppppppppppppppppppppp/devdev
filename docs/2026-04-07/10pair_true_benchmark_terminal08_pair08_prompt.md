# 10pair True Benchmark Terminal 08 Pair 08 Prompt

Date: 2026-04-07
Status: active
Document Type: external model prompt
Canonical Path: `docs/2026-04-07/10pair_true_benchmark_terminal08_pair08_prompt.md`
Parent Order: `docs/2026-04-07/10pair_true_benchmark_10terminal_opus_order.md`
Intended Report Path: `docs/2026-04-07/10pair_true_benchmark_terminal08_pair08_report.md`

## Mission

Run a read-only true benchmark audit for canonical pair `08` only.
...
7. `work_guards/08_pantech_cyworld_reborn.yaml`
8. `treatments/08_pantech_cyworld_reborn_tr_block_070_draft.json`
9. `bible/08_bi_pantech_cyworld_reborn.json`
...
- authority-ticket strength is real only if the ticket lands on time; late authority rescue cannot backfill an empty opening window

## Required Output

Create the final markdown report directly at:

- `docs/2026-04-07/10pair_true_benchmark_terminal08_pair08_report.md`
