# 10pair True Benchmark Terminal 02 Pair 02 Prompt

Date: 2026-04-07
Status: active
Document Type: external model prompt
Canonical Path: `docs/2026-04-07/10pair_true_benchmark_terminal02_pair02_prompt.md`
Parent Order: `docs/2026-04-07/10pair_true_benchmark_10terminal_opus_order.md`
Intended Report Path: `docs/2026-04-07/10pair_true_benchmark_terminal02_pair02_report.md`

## Mission

Run a read-only true benchmark audit for canonical pair `02` only.
...
7. `work_guards/02_chaebol_allowance_zero.yaml`
8. `treatments/02_chaebol_allowance_zero_tr_block_070_draft.json`
9. `bible/02_bi_chaebol_allowance_zero.json`
...
- survival, allowance continuation, or temporary probation escape do not count as visible cider unless status or control shifts on-page
