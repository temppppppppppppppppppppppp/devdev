# 10pair True Benchmark Terminal 04 Pair 04 Prompt

Date: 2026-04-07
Status: active
Document Type: external model prompt
Canonical Path: `docs/2026-04-07/10pair_true_benchmark_terminal04_pair04_prompt.md`
Parent Order: `docs/2026-04-07/10pair_true_benchmark_10terminal_opus_order.md`
Intended Report Path: `docs/2026-04-07/10pair_true_benchmark_terminal04_pair04_report.md`

## Mission

Run a read-only true benchmark audit for canonical pair `04` only.
...
7. `work_guards/04_defense_defect_engineer.yaml`
8. `treatments/04_defense_defect_engineer_tr_block_070_draft.json`
9. `bible/04_bi_defense_defect_engineer.json`
...
- technical correctness, defect analysis, or domain explanation alone is not cider; require procurement, standard, approval, or control shift

## Required Output

Create the final markdown report directly at:

- `docs/2026-04-07/10pair_true_benchmark_terminal04_pair04_report.md`
