# 10pair True Benchmark Terminal 03 Pair 03 Prompt

Date: 2026-04-07
Status: active
Document Type: external model prompt
Canonical Path: `docs/2026-04-07/10pair_true_benchmark_terminal03_pair03_prompt.md`
Parent Order: `docs/2026-04-07/10pair_true_benchmark_10terminal_opus_order.md`
Intended Report Path: `docs/2026-04-07/10pair_true_benchmark_terminal03_pair03_report.md`

## Mission

Run a read-only true benchmark audit for canonical pair `03` only.
...
7. `work_guards/03_chaebol_ent_empire.yaml`
8. `treatments/03_chaebol_ent_empire_tr_block_070_draft.json`
9. `bible/03_bi_chaebol_ent_empire.json`
...
- hype, buzz, or fan reaction alone is not enough; require concrete slot, IP, distribution, or authority ticket

## Required Output

Create the final markdown report directly at:

- `docs/2026-04-07/10pair_true_benchmark_terminal03_pair03_report.md`
