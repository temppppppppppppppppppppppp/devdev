# Pair Benchmark Terminal 08 Pair 08 Prompt

Date: 2026-04-07
Status: active
Document Type: external model prompt
Canonical Path: `docs/2026-04-07/09pair_benchmark_terminal08_pair08_prompt.md`
Parent Order: `docs/2026-04-07/09pair_production_pair_benchmark_9terminal_opus_order.md`
Intended Report Path: `docs/2026-04-07/09pair_benchmark_terminal08_pair08_report.md`

## Mission

Run a read-only benchmark audit for pair `08` only.
...
6. this prompt
7. `treatments/08_pantech_cyworld_reborn_tr_block_070_draft.json`
8. `bible/08_bi_pantech_cyworld_reborn.json`
...
- this pair is an authority-ticket benchmark, so verify the exact reward token and next-gate linkage
- if the pair wins mainly by atmosphere or nostalgia without visible authority transfer, grade that directly

## Required Output

Create the final markdown report directly at:

- `docs/2026-04-07/09pair_benchmark_terminal08_pair08_report.md`
