...
- Rebased authority on two inputs:
  - current source tree
  - selected durable runtime artifacts from `projects/00_260315`
...
- Promoted runtime-proven persistence/observability defects ahead of desktop/control-plane hardening in the roadmap order.
