...
**핵심 제안: "30화 전문" 전략을 "Sliding Window + Summary" 방식으로 전환**
- 최근 5화: 원고 전문
- 6~15화: 핵심 사건 요약 (5화당 1K자 = 2K자)
- 16~30화: 1줄 요약 (15화 = 1.5K자)
- 예상 절감: 250K자 → 40K자 (**84% 절감**)
...
| 30화 전문 → Sliding Window | ~3M input 토큰 | 높음 |
...
| # | 조치 | 예상 절감 | 위험 |
|---|------|---------|------|
| C-1 | 30화 전문 → Sliding Window + Summary | $3.00/ep | 중간 |
| C-2 | 선 Python 검증 → 조건부 LLM 호출 | $1.00/ep | 중간 |

**Phase C 총 절감: ~$4.00/ep (추가 50% 절감)**
