...
- advance the immediate-next action to `Tranche 2. Strict Local-Fix Contract Gate`
- require static validation plus a narrow snapshot commit before tranche 3 is allowed to start
