...
INVESTMENT_STRATEGIES = {
    "1996": {
        "hot": [
            {
                "type": "외환 (USD)",
                "reason": "IMF 직전, 달러 급등 예정 (800→1700)",
                "timing": "1996-1997",
                "risk": "중",
                "return": "200%+",
            },
...
ROMANCE_RULES = {
    "protagonist": {
        ...
        "priority": "사업/복수 > 로맨스",
        "typical_response": ["바쁘다는 핑계", "관심 없다는 듯한 태도", "사업 얘기로 화제 전환", "과거의 트라우마 암시"],
    },
    "female_npcs": {
...
# 성장 곡선 템플릿
POWER_PROGRESSION = {
    "initial": {"phase": "바닥", "capital_range": "0 ~ 1억", "network": "없음", "reputation": "무명", "blocks": "1-10"},
    "early": {
        "phase": "종잣돈 확보",
