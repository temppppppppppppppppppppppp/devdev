...
CATEGORIES = {
    ...
    "real_estate": {
        ...
        "subcategories": [
            "재개발/재건축", "신도시/택지", "상가/오피스", "토지투자",
            "경매/공매", "분양권", "오피스텔/도시형생활주택", "해외부동산",
            "리츠/부동산펀드", "임대사업"
        ]
    },
    "stock_equity": {
        ...
        "target_count": 20,
        "subcategories": [
            "IPO/공모주", "우량주/블루칩", "성장주", "가치주", "배당주",
            "테마주/작전주", "비상장주식", "스팩(SPAC)", "해외주식", "ETF/ETN"
        ]
    },
    "derivatives_forex": {
        "name": "파생상품/외환",
        ...
        "target_count": 12,
        "subcategories": [
            "주가지수선물", "개별주식옵션", "통화선물/옵션", "원자재선물",
            "외환(FX)거래", "금/은 투자", "원유/에너지", "농산물", "ELS/DLS"
        ]
    },
    "crypto_blockchain": {
        "name": "암호화폐/블록체인",
        ...
        "target_count": 12,
        "subcategories": [
            "비트코인", "이더리움", "알트코인", "ICO/IEO", "NFT",
            "디파이(DeFi)", "거래소/플랫폼", "채굴/스테이킹", "블록체인 서비스"
        ]
    },
    "alternative_investment": {
        ...
        "target_count": 8,
        "subcategories": [
            "미술품/골동품", "와인/위스키", "명품/시계", "자동차/클래식카",
            "음악저작권", "영화/드라마 투자", "스포츠선수 계약", "희귀품/수집품"
        ]
    },
    ...
    "it_tech": {
        ...
        "target_count": 18,
        "subcategories": [
            "포털/검색", "소셜미디어", "이커머스플랫폼", "클라우드/SaaS",
            "AI/머신러닝", "빅데이터", "사이버보안", "핀테크", "에듀테크",
            "모바일앱", "게임개발", "VR/AR/메타버스"
        ]
    },
    "semiconductor_electronics": {
        ...
        "target_count": 12,
        "subcategories": [
            "메모리반도체", "시스템반도체(파운드리)", "반도체장비", "반도체소재",
            "디스플레이패널", "2차전지/배터리", "전자부품", "PCB/기판"
        ]
    },
    "manufacturing": {
        "name": "중공업/제조",
        ...
        "target_count": 12,
        "subcategories": [
            "자동차완성차", "자동차부품", "조선/해양", "철강/비철금속",
            "기계/로봇", "항공우주", "방위산업", "섬유/의류제조"
        ]
    },
    "energy_resources": {
        "name": "에너지/자원",
        ...
        "target_count": 10,
        "subcategories": [
            "석유/가스개발", "정유/석유화학", "신재생에너지", "원자력",
            "광물/희토류", "탄소배출권", "수소경제", "ESS/전력저장"
        ]
    },
    "bio_healthcare": {
        "name": "바이오/헬스케어",
        ...
        "target_count": 12,
        "subcategories": [
            "신약개발", "바이오시밀러", "의료기기", "진단키트",
            "디지털헬스케어", "원격의료", "병원/요양", "건강기능식품"
        ]
    },
    ...
    "retail_distribution": {
        ...
        "target_count": 12,
        "subcategories": [
            "백화점/쇼핑몰", "대형마트/슈퍼", "편의점", "홈쇼핑/T커머스",
            "온라인쇼핑몰", "소셜커머스", "프랜차이즈본사", "물류/배송"
        ]
    },
    "food_beverage": {
        "name": "식품/음료",
        ...
        "target_count": 10,
        "subcategories": [
            "식품제조", "음료/주류", "외식프랜차이즈", "카페/베이커리",
            "배달플랫폼", "밀키트/간편식", "유기농/친환경", "수입식품"
        ]
    },
    "content_entertainment": {
        ...
        "target_count": 12,
        "subcategories": [
            "게임(PC/모바일/콘솔)", "영화제작/배급", "드라마/예능제작",
            "음악/엔터기획사", "웹툰/웹소설플랫폼", "OTT/스트리밍",
            "유튜브/MCN", "이스포츠", "공연/페스티벌"
        ]
    },
    "travel_leisure": {
        "name": "여행/레저",
        ...
        "target_count": 10,
        "subcategories": [
            "여행사/OTA", "항공사", "호텔/리조트", "카지노/복합리조트",
            "테마파크", "골프장", "스포츠센터", "아웃도어/캠핑"
        ]
    },
    "education": {
        "name": "교육/입시",
        ...
        "target_count": 10,
        "subcategories": [
            "입시학원", "어학원/유학", "온라인강의", "에듀테크",
            "유아교육", "직업훈련", "자격증/공무원", "기업교육"
        ]
    },
    "beauty_fashion": {
        "name": "뷰티/패션",
        ...
        "target_count": 10,
        "subcategories": [
            "화장품제조", "K-뷰티브랜드", "패션브랜드", "스포츠웨어",
            "명품유통", "뷰티플랫폼", "헤어/네일샵", "성형/피부과"
        ]
    },
    ...
    "construction_infra": {
        ...
        "target_count": 10,
        "subcategories": [
            "주택건설", "상업/오피스건설", "토목/SOC", "플랜트",
            "건설자재", "인테리어/리모델링", "스마트시티", "데이터센터"
        ]
    },
    ...
    "financial_services": {
        ...
        "target_count": 12,
        "subcategories": [
            "은행/저축은행", "증권사", "자산운용", "보험사",
            "캐피탈/리스", "P2P금융", "간편결제", "로보어드바이저"
        ]
    },
    ...
    "crisis_event": {
        ...
        "target_count": 15,
        "subcategories": [
            "IMF외환위기", "글로벌금융위기", "유럽재정위기", "코로나팬데믹",
            "부동산버블/붕괴", "주식시장폭락", "환율급변", "전쟁/지정학리스크",
            "자연재해", "정권교체/정책변화"
        ]
    },
    ...
    "emerging_future": {
        ...
        "target_count": 10,
        "subcategories": [
            "자율주행", "드론/UAM", "우주산업", "양자컴퓨팅",
            "합성생물학", "푸드테크", "스마트팜", "탄소중립기술"
        ]
    }
}
...
class OpportunityLLM:
    ...
    def generate(self, prompt: str, temperature: float = 0.7, retry_count: int = 3) -> Optional[dict]:
        """JSON 응답 생성 (재시도 + 폴백)"""
...
def build_supplementary_prompt(category_key: str, category_info: dict, era: dict,
                                existing_opportunities: list, target_subcategories: list) -> str:
    """보충 생성 프롬프트 (누락된 소분류)"""
...
class OpportunityDBBuilder:
    ...
    def generate_category_era(self, category_key: str, era: dict,
                               existing_names: list = None) -> list:
        ...
        if opportunities:
            ...
            if missing_subcats and len(opportunities) < target_count:
                progress.update(f"[{era['name']}] {category_info['name']} 보충 생성 중... (누락: {len(missing_subcats)}개 소분류)")

                supp_prompt = build_supplementary_prompt(
                    category_key, category_info, era,
                    opportunities, list(missing_subcats)
                )
    ...
    def generate_all(self, categories: list = None, eras: list = None, deep_mode: bool = True):
        ...
        for category_key in categories:
            ...
            print(f"\n{'='*60}")
            print(f"[{cat_info['name']}] - 소분류 {len(cat_info['subcategories'])}개, 목표 {cat_info['target_count']}개/시대")
            print(f"{'='*60}")
            ...
            for era in eras:
                ...
                opportunities = self.generate_category_era(
                    category_key, era, existing_names
                )
    ...
    def save(self):
        ...
        for cat_key in CATEGORIES.keys():
            cat_opps = [o for o in self.db["opportunities"]
                       if o.get("_source_category") == cat_key]
            if cat_opps:
