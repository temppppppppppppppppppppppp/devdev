...
def load_arc_tactical(context, ep_num: int) -> str:
    ...
    # 파일에서 시도
    arc_file = os.path.join(os.path.dirname(__file__), "project", "plans", "arcs", f"arc_{arc_no:03d}.txt")
