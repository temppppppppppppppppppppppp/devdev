...
def _make_orchestrator() -> ValidationOrchestrator:
    ...
    orch.scoring.validate = MagicMock(return_value={
        "passed": True,
        "score": 80,
        "feedback": "",
        "violations": [],
    ...
    orch.advisory.validate = MagicMock(return_value={
        "passed": True,
        "suggestions": [],
        "feedback": "",
    })
...
def test_blocking_failure_calls_failure_learner_record_failure():
    ...
    orch.blocking.validate = MagicMock(return_value={
        "passed": False,
        "failures": [
            {
    ...
    orch.continuity.validate = MagicMock(return_value={
        "tier": "CONTINUITY",
        "passed": True,
        "violations": [],
        "warnings": [],
    ...
    orch.consistency.validate = MagicMock(return_value={
        "passed": True,
    ...
    assert failure_learner.record_failure.called, (
        "FailureLearner.record_failure must be called when BLOCKING fails"
    )
