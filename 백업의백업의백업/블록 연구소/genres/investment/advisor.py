...
class InvestmentAdvisor:
    ...
    def get_investment_recommendations(self, current_block: int, total_blocks: int = 60) -> dict:
        ...
        recommendations = {"current_phase": "", "hot_investments": [], "avoid": [], "upcoming_events": [], "advice": ""}
        ...
        recommendations["upcoming_events"] = sorted(recommendations["upcoming_events"], key=lambda x: x["month"])[:5]

        return recommendations

    def get_figure_recommendation(
        self, current_block: int, total_blocks: int = 60, used_figures: list[str] = None
    ) -> list[dict]:
